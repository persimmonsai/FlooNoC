...
#(
  ...
  input floo_req_t                        hbm_north_dram_0_floo_req_i,
  input floo_rsp_t                        hbm_north_dram_0_floo_rsp_i,
  input floo_wide_t                        hbm_north_dram_0_floo_wide_i,
  output floo_req_t                        hbm_north_dram_0_floo_req_o,
  output floo_rsp_t                        hbm_north_dram_0_floo_rsp_o,
  output floo_wide_t                        hbm_north_dram_0_floo_wide_o,
  input floo_req_t                        hbm_north_dram_1_floo_req_i,
  input floo_rsp_t                        hbm_north_dram_1_floo_rsp_i,
  input floo_wide_t                        hbm_north_dram_1_floo_wide_i,
  output floo_req_t                        hbm_north_dram_1_floo_req_o,
  output floo_rsp_t                        hbm_north_dram_1_floo_rsp_o,
  output floo_wide_t                        hbm_north_dram_1_floo_wide_o,
  input floo_req_t                        hbm_north_2_floo_req_i,
  input floo_rsp_t                        hbm_north_2_floo_rsp_i,
  input floo_wide_t                        hbm_north_2_floo_wide_i,
  output floo_req_t                        hbm_north_2_floo_req_o,
  output floo_rsp_t                        hbm_north_2_floo_rsp_o,
  output floo_wide_t                        hbm_north_2_floo_wide_o,
  input floo_req_t                        hbm_north_3_floo_req_i,
  input floo_rsp_t                        hbm_north_3_floo_rsp_i,
  input floo_wide_t                        hbm_north_3_floo_wide_i,
  output floo_req_t                        hbm_north_3_floo_req_o,
  output floo_rsp_t                        hbm_north_3_floo_rsp_o,
  output floo_wide_t                        hbm_north_3_floo_wide_o,
  input floo_req_t                       [1:0] hbm_south_0_floo_req_i,
  input floo_rsp_t                       [1:0] hbm_south_0_floo_rsp_i,
  input floo_wide_t                       [1:0] hbm_south_0_floo_wide_i,
  output floo_req_t                       [1:0] hbm_south_0_floo_req_o,
  output floo_rsp_t                       [1:0] hbm_south_0_floo_rsp_o,
  output floo_wide_t                       [1:0] hbm_south_0_floo_wide_o,
  input floo_req_t                       [1:0] hbm_south_2_floo_req_i,
  input floo_rsp_t                       [1:0] hbm_south_2_floo_rsp_i,
  input floo_wide_t                       [1:0] hbm_south_2_floo_wide_i,
  output floo_req_t                       [1:0] hbm_south_2_floo_req_o,
  output floo_rsp_t                       [1:0] hbm_south_2_floo_rsp_o,
  output floo_wide_t                       [1:0] hbm_south_2_floo_wide_o,
...
floo_wide_t [West:North] router_0_0_wide_out;
  ...
  assign router_0_0_rsp_in[West] = hbm_west_floo_rsp_i[0];
  ...
  assign router_0_0_wide_in[West] = hbm_west_floo_wide_i[0];
  ...
  assign hbm_west_floo_wide_o[0] = router_0_0_wide_out[West];
...
floo_wide_t [West:North] router_0_1_wide_out;
  ...
  assign router_0_1_req_in[West] = hbm_west_floo_req_i[1];
  ...
  assign hbm_west_floo_rsp_o[1] = router_0_1_rsp_out[West];
  ...
  assign hbm_west_floo_req_o[1] = router_0_1_req_out[West];
  ...
  assign router_0_1_rsp_in[West] = hbm_west_floo_rsp_i[1];
  ...
  assign router_0_1_wide_in[West] = hbm_west_floo_wide_i[1];
  ...
  assign hbm_west_floo_wide_o[1] = router_0_1_wide_out[West];
...
floo_wide_t [West:North] router_0_2_wide_out;
  ...
  assign router_0_2_req_in[West] = hbm_west_floo_req_i[2];
  ...
  assign hbm_west_floo_rsp_o[2] = router_0_2_rsp_out[West];
  ...
  assign hbm_west_floo_req_o[2] = router_0_2_req_out[West];
  ...
  assign router_0_2_rsp_in[West] = hbm_west_floo_rsp_i[2];
  ...
  assign router_0_2_wide_in[West] = hbm_west_floo_wide_i[2];
  ...
  assign hbm_west_floo_wide_o[2] = router_0_2_wide_out[West];
...
floo_wide_t [West:North] router_0_3_wide_out;
  ...
  assign router_0_3_rsp_in[West] = hbm_west_floo_rsp_i[3];
  ...
  assign router_0_3_wide_in[West] = hbm_west_floo_wide_i[3];
  ...
  assign hbm_west_floo_wide_o[3] = router_0_3_wide_out[West];
...
floo_wide_t [West:North] router_1_0_wide_out;
  ...
  assign router_1_0_req_in[South] = hbm_south_0_floo_req_i[0];
  ...
  assign hbm_south_0_floo_rsp_o[0] = router_1_0_rsp_out[South];
  ...
  assign hbm_south_0_floo_req_o[0] = router_1_0_req_out[South];
  ...
  assign router_1_0_rsp_in[South] = hbm_south_0_floo_rsp_i[0];
  ...
  assign router_1_0_wide_in[South] = hbm_south_0_floo_wide_i[0];
  ...
  assign hbm_south_0_floo_wide_o[0] = router_1_0_wide_out[South];
...
floo_wide_t [West:North] router_1_3_wide_out;
  ...
  assign router_1_3_req_in[North] = hbm_north_2_floo_req_i;
  ...
  assign hbm_north_2_floo_rsp_o = router_1_3_rsp_out[North];
  ...
  assign hbm_north_2_floo_req_o = router_1_3_req_out[North];
  ...
  assign router_1_3_rsp_in[North] = hbm_north_2_floo_rsp_i;
  ...
  assign router_1_3_wide_in[North] = hbm_north_2_floo_wide_i;
  ...
  assign hbm_north_2_floo_wide_o = router_1_3_wide_out[North];
...
floo_wide_t [West:North] router_2_0_wide_out;
  ...
  assign router_2_0_req_in[South] = hbm_south_0_floo_req_i[1];
  ...
  assign hbm_south_0_floo_rsp_o[1] = router_2_0_rsp_out[South];
  ...
  assign hbm_south_0_floo_req_o[1] = router_2_0_req_out[South];
  ...
  assign router_2_0_rsp_in[South] = hbm_south_0_floo_rsp_i[1];
  ...
  assign router_2_0_wide_in[South] = hbm_south_0_floo_wide_i[1];
  ...
  assign hbm_south_0_floo_wide_o[1] = router_2_0_wide_out[South];
...
floo_wide_t [West:North] router_2_3_wide_out;
  ...
  assign router_2_3_req_in[North] = hbm_north_dram_0_floo_req_i;
  ...
  assign hbm_north_dram_0_floo_rsp_o = router_2_3_rsp_out[North];
  ...
  assign hbm_north_dram_0_floo_req_o = router_2_3_req_out[North];
  ...
  assign router_2_3_rsp_in[North] = hbm_north_dram_0_floo_rsp_i;
  ...
  assign router_2_3_wide_in[North] = hbm_north_dram_0_floo_wide_i;
  ...
  assign hbm_north_dram_0_floo_wide_o = router_2_3_wide_out[North];
...
floo_wide_t [West:North] router_4_0_wide_out;
  ...
  assign router_4_0_req_in[South] = hbm_south_2_floo_req_i[0];
  ...
  assign hbm_south_2_floo_rsp_o[0] = router_4_0_rsp_out[South];
  ...
  assign hbm_south_2_floo_req_o[0] = router_4_0_req_out[South];
  ...
  assign router_4_0_rsp_in[South] = hbm_south_2_floo_rsp_i[0];
  ...
  assign router_4_0_wide_in[South] = hbm_south_2_floo_wide_i[0];
  ...
  assign hbm_south_2_floo_wide_o[0] = router_4_0_wide_out[South];
...
floo_wide_t [West:North] router_4_3_wide_out;
  ...
  assign router_4_3_req_in[North] = hbm_north_dram_1_floo_req_i;
  ...
  assign hbm_north_dram_1_floo_rsp_o = router_4_3_rsp_out[North];
  ...
  assign hbm_north_dram_1_floo_req_o = router_4_3_req_out[North];
  ...
  assign router_4_3_rsp_in[North] = hbm_north_dram_1_floo_rsp_i;
  ...
  assign router_4_3_wide_in[North] = hbm_north_dram_1_floo_wide_i;
  ...
  assign hbm_north_dram_1_floo_wide_o = router_4_3_wide_out[North];
...
floo_wide_t [West:North] router_5_0_wide_out;
  ...
  assign router_5_0_req_in[South] = hbm_south_2_floo_req_i[1];
  ...
  assign hbm_south_2_floo_rsp_o[1] = router_5_0_rsp_out[South];
  ...
  assign hbm_south_2_floo_req_o[1] = router_5_0_req_out[South];
  ...
  assign router_5_0_rsp_in[South] = hbm_south_2_floo_rsp_i[1];
  ...
  assign router_5_0_wide_in[South] = hbm_south_2_floo_wide_i[1];
  ...
  assign hbm_south_2_floo_wide_o[1] = router_5_0_wide_out[South];
...
floo_wide_t [West:North] router_5_3_wide_out;
  ...
  assign router_5_3_req_in[North] = hbm_north_3_floo_req_i;
  ...
  assign hbm_north_3_floo_rsp_o = router_5_3_rsp_out[North];
  ...
  assign hbm_north_3_floo_req_o = router_5_3_req_out[North];
  ...
  assign router_5_3_rsp_in[North] = hbm_north_3_floo_rsp_i;
  ...
  assign router_5_3_wide_in[North] = hbm_north_3_floo_wide_i;
  ...
  assign hbm_north_3_floo_wide_o = router_5_3_wide_out[North];
...
floo_wide_t [West:North] router_6_0_wide_out;
  ...
  assign router_6_0_req_in[East] = hbm_east_floo_req_i[0];
  ...
  assign router_6_0_wide_in[East] = hbm_east_floo_wide_i[0];
  ...
  assign hbm_east_floo_wide_o[0] = router_6_0_wide_out[East];
...
floo_wide_t [West:North] router_6_1_wide_out;
  ...
  assign router_6_1_req_in[East] = hbm_east_floo_req_i[1];
  ...
  assign hbm_east_floo_rsp_o[1] = router_6_1_rsp_out[East];
  ...
  assign hbm_east_floo_req_o[1] = router_6_1_req_out[East];
  ...
  assign router_6_1_rsp_in[East] = hbm_east_floo_rsp_i[1];
  ...
  assign router_6_1_wide_in[East] = hbm_east_floo_wide_i[1];
  ...
  assign hbm_east_floo_wide_o[1] = router_6_1_wide_out[East];
...
floo_wide_t [West:North] router_6_2_wide_out;
  ...
  assign router_6_2_req_in[East] = hbm_east_floo_req_i[2];
  ...
  assign hbm_east_floo_rsp_o[2] = router_6_2_rsp_out[East];
  ...
  assign hbm_east_floo_req_o[2] = router_6_2_req_out[East];
  ...
  assign router_6_2_rsp_in[East] = hbm_east_floo_rsp_i[2];
  ...
  assign router_6_2_wide_in[East] = hbm_east_floo_wide_i[2];
  ...
  assign hbm_east_floo_wide_o[2] = router_6_2_wide_out[East];
...
floo_wide_t [West:North] router_6_3_wide_out;
  ...
  assign router_6_3_req_in[East] = hbm_east_floo_req_i[3];
  ...
  assign router_6_3_wide_in[East] = hbm_east_floo_wide_i[3];
  ...
  assign hbm_east_floo_wide_o[3] = router_6_3_wide_out[East];
