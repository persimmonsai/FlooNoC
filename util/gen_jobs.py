...
# # TODO : It's need to added 'soc_type' attribute to 'compute_tile_array.yml'
# AddrMap = [
#     {"idx": {"x": 1, "y": 1}, "name": "cluster", "soc_type": "cluster", "narrow": True, "wide": True, "start_addr": int("0x000010000000",16), "end_addr": int("0x000010040000",16)},
#     {"idx": {"x": 1, "y": 2}, "name": "cluster", "soc_type": "cluster", "narrow": True, "wide": True, "start_addr": int("0x000010080000",16), "end_addr": int("0x0000100c0000",16)},
#     {"idx": {"x": 2, "y": 1}, "name": "cluster", "soc_type": "cluster", "narrow": True, "wide": True, "start_addr": int("0x000010040000",16), "end_addr": int("0x000010080000",16)},
#     {"idx": {"x": 2, "y": 2}, "name": "cluster", "soc_type": "cluster", "narrow": True, "wide": True, "start_addr": int("0x0000100c0000",16), "end_addr": int("0x000010100000",16)},
#     {"idx": {"x": 1, "y": 3}, "name": "hbm_north", "soc_type": "memory", "narrow": True, "wide": True, "start_addr": int("0x000080000000",16), "end_addr": int("0x0000c0000000",16)},
#     {"idx": {"x": 2, "y": 3}, "name": "hbm_north", "soc_type": "memory", "narrow": True, "wide": True, "start_addr": int("0x0000c0000000",16), "end_addr": int("0x000100000000",16)},
#     {"idx": {"x": 1, "y": 0}, "name": "hbm_south", "soc_type": "memory", "narrow": True, "wide": True, "start_addr": int("0x000800000000",16), "end_addr": int("0x000840000000",16)},
#     {"idx": {"x": 2, "y": 0}, "name": "hbm_south", "soc_type": "memory", "narrow": True, "wide": True, "start_addr": int("0x000840000000",16), "end_addr": int("0x000880000000",16)},
#     {"idx": {"x": 0, "y": 2}, "name": "pcie", "soc_type": "serial_link", "narrow": True, "wide": True,"start_addr": int("0x010000000000",16), "end_addr": int("0x010100000000",16)},
#     {"idx": {"x": 3, "y": 1}, "name": "peripherals", "soc_type": "peripheral", "narrow": True, "wide": False,"start_addr": int("0x000000000000",16), "end_addr": int("0x000000ffffff",16)},
#     {"idx": {"x": 3, "y": 2}, "name": "peripherals", "soc_type": "peripheral", "narrow": True, "wide": False,"start_addr": int("0x000000ffffff",16), "end_addr": int("0x000001fffffe",16)}
# ]
# # -------------------------------------------------------
