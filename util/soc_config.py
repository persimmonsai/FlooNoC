...
AddrMap = [
	...
	{"idx": {"x": 1, "y": 5}, "name": "hbm_north", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x001000000000",16), "end_addr": int("0x001040000000",16)},
	{"idx": {"x": 2, "y": 5}, "name": "hbm_north", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x001040000000",16), "end_addr": int("0x001080000000",16)},
	{"idx": {"x": 3, "y": 5}, "name": "hbm_north", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x001080000000",16), "end_addr": int("0x0010c0000000",16)},
	{"idx": {"x": 4, "y": 5}, "name": "hbm_north", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x0010c0000000",16), "end_addr": int("0x001100000000",16)},
	{"idx": {"x": 5, "y": 5}, "name": "hbm_north", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x001100000000",16), "end_addr": int("0x001140000000",16)},
	{"idx": {"x": 6, "y": 5}, "name": "hbm_north", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x001140000000",16), "end_addr": int("0x001180000000",16)},
	{"idx": {"x": 7, "y": 5}, "name": "hbm_north", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x001180000000",16), "end_addr": int("0x0011c0000000",16)},
	{"idx": {"x": 8, "y": 5}, "name": "hbm_north", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x0011c0000000",16), "end_addr": int("0x001200000000",16)},
	{"idx": {"x": 1, "y": 0}, "name": "hbm_south", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x000200000000",16), "end_addr": int("0x000240000000",16)},
	{"idx": {"x": 2, "y": 0}, "name": "hbm_south", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x000240000000",16), "end_addr": int("0x000280000000",16)},
	{"idx": {"x": 3, "y": 0}, "name": "hbm_south", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x000280000000",16), "end_addr": int("0x0002c0000000",16)},
	{"idx": {"x": 4, "y": 0}, "name": "hbm_south", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x0002c0000000",16), "end_addr": int("0x000300000000",16)},
	{"idx": {"x": 5, "y": 0}, "name": "hbm_south", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x000300000000",16), "end_addr": int("0x000340000000",16)},
	{"idx": {"x": 6, "y": 0}, "name": "hbm_south", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x000340000000",16), "end_addr": int("0x000380000000",16)},
	{"idx": {"x": 7, "y": 0}, "name": "hbm_south", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x000380000000",16), "end_addr": int("0x0003c0000000",16)},
	{"idx": {"x": 8, "y": 0}, "name": "hbm_south", "mgr_port": {"narrow": False, "wide": False}, "sbr_port": {"narrow": True, "wide": True}, "start_addr": int("0x0003c0000000",16), "end_addr": int("0x000400000000",16)},
